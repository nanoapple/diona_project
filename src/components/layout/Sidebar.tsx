...
const Sidebar = () => {
  ...
  const ModuleNavItem = ({ 
    ...
    const categoryColors: Record<string, {
      ...
      "Core Platform": {
        bg: "bg-[hsl(140,15%,88%)]",
        border: "border-[hsl(140,18%,72%)]",
        text: "text-[hsl(140,20%,30%)]",
        icon: "text-[hsl(140,20%,35%)]",
        hover: "hover:bg-[hsl(140,18%,75%)] hover:text-[hsl(140,25%,22%)] hover:border-[hsl(140,20%,62%)]",
        hoverIcon: "group-hover:text-[hsl(140,25%,22%)]",
        active: "bg-[hsl(140,20%,68%)] border-[hsl(140,22%,58%)] text-[hsl(140,30%,18%)]",
        disabled: "bg-[hsl(0,0%,90%)] border-[hsl(0,0%,80%)] text-[hsl(0,0%,55%)]"
      },
      "Clinical Workflow": {
        bg: "bg-[hsl(217,12%,88%)]",
        border: "border-[hsl(217,15%,72%)]",
        text: "text-[hsl(217,18%,30%)]",
        icon: "text-[hsl(217,18%,35%)]",
        hover: "hover:bg-[hsl(217,15%,75%)] hover:text-[hsl(217,22%,22%)] hover:border-[hsl(217,18%,62%)]",
        hoverIcon: "group-hover:text-[hsl(217,22%,22%)]",
        active: "bg-[hsl(217,18%,68%)] border-[hsl(217,20%,58%)] text-[hsl(217,25%,18%)]",
        disabled: "bg-[hsl(0,0%,90%)] border-[hsl(0,0%,80%)] text-[hsl(0,0%,55%)]"
      },
      "Collaboration & Client Engagement": {
        bg: "bg-[hsl(190,15%,88%)]",
        border: "border-[hsl(190,18%,72%)]",
        text: "text-[hsl(190,20%,30%)]",
        icon: "text-[hsl(190,20%,35%)]",
        hover: "hover:bg-[hsl(190,18%,75%)] hover:text-[hsl(190,25%,22%)] hover:border-[hsl(190,20%,62%)]",
        hoverIcon: "group-hover:text-[hsl(190,25%,22%)]",
        active: "bg-[hsl(190,20%,68%)] border-[hsl(190,22%,58%)] text-[hsl(190,30%,18%)]",
        disabled: "bg-[hsl(0,0%,90%)] border-[hsl(0,0%,80%)] text-[hsl(0,0%,55%)]"
      },
      "Knowledge & Professional Development": {
        bg: "bg-[hsl(270,12%,88%)]",
        border: "border-[hsl(270,15%,72%)]",
        text: "text-[hsl(270,18%,30%)]",
        icon: "text-[hsl(270,18%,35%)]",
        hover: "hover:bg-[hsl(270,15%,75%)] hover:text-[hsl(270,22%,22%)] hover:border-[hsl(270,18%,62%)]",
        hoverIcon: "group-hover:text-[hsl(270,22%,22%)]",
        active: "bg-[hsl(270,18%,68%)] border-[hsl(270,20%,58%)] text-[hsl(270,25%,18%)]",
        disabled: "bg-[hsl(0,0%,90%)] border-[hsl(0,0%,80%)] text-[hsl(0,0%,55%)]"
      },
      "Compliance & Operations": {
        bg: "bg-[hsl(35,18%,88%)]",
        border: "border-[hsl(35,22%,72%)]",
        text: "text-[hsl(35,25%,30%)]",
        icon: "text-[hsl(35,25%,35%)]",
        hover: "hover:bg-[hsl(35,22%,75%)] hover:text-[hsl(35,30%,22%)] hover:border-[hsl(35,25%,62%)]",
        hoverIcon: "group-hover:text-[hsl(35,30%,22%)]",
        active: "bg-[hsl(35,25%,68%)] border-[hsl(35,28%,58%)] text-[hsl(35,35%,18%)]",
        disabled: "bg-[hsl(0,0%,90%)] border-[hsl(0,0%,80%)] text-[hsl(0,0%,55%)]"
      }
    } : {
      "Core Platform": {
