      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            {/* Appointment Basics */}
            <div className="space-y-3 p-4 bg-background/50 rounded-lg border shadow-sm">
            ...
            {!isLimitedUser && !isClientFacing && (
              <div className="space-y-3 p-4 bg-background/50 rounded-lg border shadow-sm opacity-50">
                <h3 className="font-semibold text-lg">2. Case/Client Association</h3>
