  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await createClient({
        ...
        ndis_start_date: formData.ndisStartDate ? `${formData.ndisStartDate.getFullYear()}-${String(formData.ndisStartDate.getMonth() + 1).padStart(2, '0')}-${String(formData.ndisStartDate.getDate()).padStart(2, '0')}` : undefined,
        ndis_end_date: formData.ndisEndDate ? `${formData.ndisEndDate.getFullYear()}-${String(formData.ndisEndDate.getMonth() + 1).padStart(2, '0')}-${String(formData.ndisEndDate.getDate()).padStart(2, '0')}` : undefined,
        ndis_amount_remaining: formData.ndisAmountRemaining || undefined,
        date_of_injury: formData.dateOfInjury ? `${formData.dateOfInjury.getFullYear()}-${String(formData.dateOfInjury.getMonth() + 1).padStart(2, '0')}-${String(formData.dateOfInjury.getDate()).padStart(2, '0')}` : undefined,
